...
Согласно Master Plan (Этап 11):
- После каждого успешного изменения — автоматический commit
- Генерация описания commit'а
- Связь с roadmap
"""
...
class GitIntelligence:
    ...
    def generate_commit_message(self, task_title: str, task_id: str = None) -> str:
        ...
        Связывает с roadmap, если указан task_id.
        """
